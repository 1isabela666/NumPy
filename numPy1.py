...
alturas = np.array([1.65, 1.70, 1.68, 1.72, 1.60])
idades = np.array([16, 17, 18, 17, 16])

print(alturas.mean(), alturas.std())
print(idades.max(), idades.min())

print(alturas[idades >= 17])

pesos = np.array([55, 60, 58, 65, 52])
imc = pesos / (alturas ** 2)
print(imc)
...
dados = np.random.randint(1, 7, size=1000)
...
print((dados == 6).sum() / 1000 * 100)

for n in [10, 100, 1000, 100000]:
    print(np.random.randint(1, 7, size=n).mean())